...
__twttrlr(function (using, provide, loadrunner, define) {
        ...
        using("dom/cookie", "dom/delegate", "sandbox/minimal", "util/donottrack", "util/promise", "tfw/util/guest_cookie", "tfw/util/env", "util/iframe", "util/util", "$xd/json2.js", function (t, n, r, i, s, o, u, a, f) {
            ...
            function C(e, t, n) {
                ...
                s = f.aug({}, t, {
                    ...
                    l: j(s)
                }), H(u)) : (r = p.firstChild, r.value = +r.value || +s.dnt, o = j(s), i = g.createElement("input"), i.type = "hidden", i.name = "l", i.value = o, p.appendChild(i))
            }
    ...
    provide("tfw/util/assets", function (e) {
        using("util/env", function (t) {
            ...
            var n = {
                "embed/timeline.css": {
                    "default": "embed/timeline.338330b025152a47f9a1aa6a5430459f.default.css",
                    "2x": "embed/timeline.338330b025152a47f9a1aa6a5430459f.2x.css",
                    gif: "embed/timeline.338330b025152a47f9a1aa6a5430459f.gif.css",
                    "default.rtl": "embed/timeline.338330b025152a47f9a1aa6a5430459f.default.rtl.css",
                    "2x.rtl": "embed/timeline.338330b025152a47f9a1aa6a5430459f.2x.rtl.css",
                    "gif.rtl": "embed/timeline.338330b025152a47f9a1aa6a5430459f.gif.rtl.css"
                }
            };
            e(r)
        })
    ...
    provide("tfw/widget/syndicatedbase", function (e) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/tracking", "dom/classname", "dom/get", "dom/delegate", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/typevalidator", "util/util", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d) {
            function x() {
                b = T.VALID_COLOR.test(i.val("widgets:link-color")) && RegExp.$1, E = T.VALID_COLOR.test(i.val("widgets:border-color")) && RegExp.$1, w = i.val("widgets:theme")
            }
            ...
            function T(e) {
                ...
                }, this)), t.apply(this, [e]), n = this.params(), this.targetEl = this.srcEl && this.srcEl.parentNode || n.targetEl || document.body, this.predefinedWidth = T.VALID_UNIT.test(n.width || this.attr("width")) && RegExp.$1, this.layout(d.bind(function () {
            ...
            T.prototype = new t, d.aug(T.prototype, {
                ...
                constrainMedia: function (e, t) {
                    ...
                    return d.forEach(u.all("autosized-media", e), d.bind(function (e) {
                        var i = T.scaleDimensions(e.getAttribute("data-width"), e.getAttribute("data-height"), t, r);
                        this.layout(function () {
                            i.width > 0 && (e.width = i.width), i.height > 0 && (e.height = i.height)
                        }), n = i.height > n ? i.height : n
                    }, this)), n
                }
            }), T.VALID_UNIT = /^([0-9]+)( ?px)?$/, T.VALID_COLOR = /^(#(?:[0-9a-f]{3}|[0-9a-f]{6}))$/i, T.retinize = function (e) {
                if (!l.retina()) return;
                d.forEach(e.getElementsByTagName("IMG"), function (e) {
                    var t = e.getAttribute("data-src-2x");
                    t && (e.src = t)
                })
            }, T.scaleDimensions = function (e, t, n, r) {
        ...
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "util/promise", "anim/transition", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b) {
            ...
            I.prototype = new n, m.aug(I.prototype, {
                ...
                update: function () {
                    ...
                    console.log('Se ejecuta cuando se actualizan');
                },
                loadMore: function () {
                    var e = this,
                    ...
                    this.requestTweets(n, !1, function (t) {
                        ...
                        if (t.childNodes.length > 0) {
                            console.log('Se ejecuta cuando llegan los tweets mas antiguos');
                            e.appendTweets(t);
                            twttr.events.trigger("loadMore", {
                                target: e
                            })
                ...
                insertNewTweets: function (e) {
                    var t = this,
                        ...
                        i = r.offsetHeight,
                        o;
                    console.log('-----------------Se estan insertando nuevos tweets');
                    ...
                    if (n.scrollTop > 40 || this.mouseIsOver()) {
                        ...
                        twttr.events.trigger("newTweets", {
                            target: e
                        })
                        return
                    }
    ...
    provide("tfw/widget/tweetbutton", function (e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (t, n, r, i, s, o) {
            ...
            l.prototype = new t, n.aug(l.prototype, {
                ...
                render: function (e, t) {
                    var r = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1393899192.html#" + this.parameters(),
                        i;
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function (t, n, r, i, s, o, u) {
            ...
            a.prototype = new n, t.aug(a.prototype, {
                ...
                render: function (e, n) {
                    ...
                    var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1393899192.html#" + this.parameters(),
